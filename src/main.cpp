...
// Indica se as teclas w,a,s,d estão sendo pressionadas
...
int main()
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 800, "INF01047 - 00333250 - Fernando Sulzbach", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      //  glm::mat4 view = Matrix_Camera_View(camera_position, camera_view_vector, camera_up_vector);
...

        {
            ...
            model = Matrix_Translate(1.5f, 0.5f, 0.0f)
                   * Matrix_Scale(1.0f, 2.5f, 100.0f);
            ...
            model = Matrix_Translate(x_car_position,-0.5,z_car_position)
                      * Matrix_Scale(0.25f, 0.25f, 0.75f)
            ...
            { //CHÃO
            model = Matrix_Translate(0.0f, -0.75f, 0.0f)
                  * Matrix_Scale(2.0f, 0.0f, 1000.0f);
            }
...
bool checkColision(glm::vec3 carPos, glm::vec3 obsPos)
{
